      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-500">A prototype vibe-coded by Zack Burgess and Claude Code</p>
          </div>
          ...
          <div className="text-sm space-y-2">
            <a
              href="https://github.com/zack-burgess/groups-manager-v2"
              target="_blank"
            ...
            >
              ...
              github.com/zack-burgess/groups-manager-v2
            </a>
            <a
